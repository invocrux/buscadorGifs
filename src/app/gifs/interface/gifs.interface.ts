// To parse this data:
//
//   import { Convert, SearchGifsResponsive } from "./file";
//
//   const searchGifsResponsive = Convert.toSearchGifsResponsive(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsResponsive {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsResponsive(json: string): SearchGifsResponsive {
        return cast(JSON.parse(json), r("SearchGifsResponsive"));
    }

    public static searchGifsResponsiveToJson(value: SearchGifsResponsive): string {
        return JSON.stringify(uncast(value, r("SearchGifsResponsive")), null, 2);
    }
}
